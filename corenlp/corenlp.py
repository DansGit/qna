...
def parse_xml_output(input_dir, log_path, corenlp_path=DIRECTORY, memory="3g", raw_output=False, properties='default.properties'):
...
def batch_parse(input_folder, log_path, corenlp_path=DIRECTORY, memory="3g", raw_output=False):
    """
    ...
    return parse_xml_output(input_folder, log_path, corenlp_path, memory, raw_output=raw_output)
